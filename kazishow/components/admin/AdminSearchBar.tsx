...
import {
  ...
  AlertTriangle, CreditCard, BadgeCheck, Settings, Calendar, FileText, Lightbulb, Banknote,
} from "lucide-react";
...
const PAGES = [
  ...
  { label: "Bookings",         href: "/admin/bookings",         icon: ShoppingBag,     keywords: ["booking", "bookings", "order", "orders"] },
  { label: "Disputes",         href: "/admin/disputes",         icon: AlertTriangle,   keywords: ["dispute", "disputes", "disputed", "conflict", "refund", "escalate"] },
  { label: "Commissions",      href: "/admin/commissions",      icon: Banknote,        keywords: ["commission", "commissions", "payment", "equity", "paybill", "outstanding"] },
  { label: "Subscriptions",    href: "/admin/subscriptions",    icon: CreditCard,      keywords: ["subscription", "subscriptions", "plan", "starter", "growth", "premium", "monthly"] },
  { label: "Job Applications", href: "/admin/job-applications", icon: FileText,        keywords: ["job", "jobs", "application", "applications", "applicant", "employer", "hire"] },
  { label: "Verification",     href: "/admin/verification",     icon: BadgeCheck,      keywords: ["verification", "verify", "id", "document", "kyc", "identity"] },
  { label: "Analytics",        href: "/admin/analytics",        icon: Activity,        keywords: ["analytics", "analytic", "revenue", "report", "reports", "chart", "graph"] },
  { label: "Finance",          href: "/admin/finance",          icon: DollarSign,      keywords: ["finance", "financial", "export", "income", "earnings", "revenue"] },
  ...
  { label: "Schedule",         href: "/admin/schedule",         icon: Calendar,        keywords: ["schedule", "reminder", "calendar", "upcoming", "appointment"] },
  { label: "Tips & Guides",    href: "/admin/tips",             icon: Lightbulb,       keywords: ["tip", "tips", "guide", "guides", "article", "content"] },
  ...
  { label: "Auto-Suspension",  href: "/admin/auto-suspension",  icon: ShieldAlert,     keywords: ["auto-suspension", "suspension", "suspend", "flag", "flagged", "inactive", "abuse"] },
  { label: "Settings",         href: "/admin/settings",         icon: Settings,        keywords: ["settings", "setting", "config", "configuration", "commission rate", "platform"] },
];
...
const PAGE_COLORS: Record<string, string> = {
  ...
  "/admin/disputes":         "bg-red-100 text-red-600",
  "/admin/commissions":      "bg-yellow-100 text-yellow-700",
  "/admin/subscriptions":    "bg-cyan-100 text-cyan-600",
  "/admin/job-applications": "bg-lime-100 text-lime-700",
  "/admin/verification":     "bg-green-100 text-green-600",
  "/admin/analytics":        "bg-green-100 text-green-600",
  "/admin/finance":          "bg-emerald-100 text-emerald-600",
  "/admin/withdrawals":      "bg-teal-100 text-teal-600",
  "/admin/payouts":          "bg-emerald-100 text-emerald-600",
  "/admin/schedule":         "bg-sky-100 text-sky-600",
  "/admin/tips":             "bg-yellow-100 text-yellow-600",
  ...
  "/admin/settings":         "bg-gray-100 text-gray-600",
};
