...
export default function WhatsAppBubble() {
  ...
  return (
    <div className="fixed bottom-24 md:bottom-8 right-4 z-50 flex flex-col items-end gap-2">
      {showTooltip && (
        <div className="relative bg-white rounded-2xl shadow-xl px-4 py-3 text-sm max-w-[200px] card-shadow border border-gray-100 animate-fade-in">
          <button
          ...
          <p className="font-semibold text-kazi-dark text-xs">Need help?</p>
          <p className="text-gray-500 text-xs mt-0.5">Chat with us on WhatsApp</p>
        </div>
      )}
      <a
        href="https://wa.me/254700000000?text=Hi%20KaziShow%2C%20I%20need%20help%20finding%20a%20service"
        target="_blank"
